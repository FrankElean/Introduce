<template>
		<div class="music-swipe" :style="{height: height+'px'}">
				<div class="music-swipe-items-wrap" v-el:wrap>
				
								<slot></slot>
				</div>
				<div class="music-swipe-indicators" v-show="showIndicators">
